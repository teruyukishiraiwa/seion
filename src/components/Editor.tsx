            ...
            >
              ...
              >
                ...
                <div className="relative w-full">
                  {isEmpty && <div aria-hidden style={{ position: "absolute", inset: 0, fontSize: card.bodySize, lineHeight: card.bodyLineHeight, letterSpacing: `${card.bodyLetterSpacing}em`, color: cardSubColor }}>いま感じていることを、静かに書きとめてください。</div>}
